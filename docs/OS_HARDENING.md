...
A large portion of the aggressive tracking prevention, telemetry removal, and specifically the "Privacy Over Security" configurable prompts found within this hardening suite were heavily inspired by and directly adapted from [privacy.sexy](https://github.com/undergroundwires/privacy.sexy) by undergroundwires. We highly encourage users to explore their repository for cross-platform privacy enforcement.
